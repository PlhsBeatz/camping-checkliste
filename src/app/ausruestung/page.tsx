    ...
    <div className="min-h-screen flex">
      ...
      <div className={cn(
        ...
        <div className="flex flex-col flex-1 min-h-0 min-w-0 container mx-auto p-4 md:p-6">
          {/* Header - Sticky */}
          <div className="sticky top-0 z-[60] flex-shrink-0 flex items-center justify-between bg-white shadow pb-4 -mx-4 px-4 -mt-4 pt-4 md:-mx-6 md:px-6 md:-mt-6 md:pt-6">
