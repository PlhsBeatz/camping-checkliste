        ...
        {suggestion.kind === 'platzplan' && (
          <div className="space-y-2">
            {choices.length === 0 ? (
              ...
              <div role="radiogroup" aria-label="Platzplan wählen" className="space-y-2">
                ...
                {choices.map((c) => {
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        'relative flex items-start gap-3 rounded-[10px] border px-3 py-2.5 cursor-pointer select-none transition-colors',
                        selected
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start gap-2">
                          <span className="text-sm font-medium text-brand-heading break-words">
                            {c.label}
                          </span>
                          {c.isRecommended && (
                          ...
                          <a
                            ...
                            className="ml-auto shrink-0 text-brand-heading"
                          >
